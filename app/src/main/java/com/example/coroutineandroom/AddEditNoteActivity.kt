...
import com.example.coroutineandroom.R
import kotlinx.android.synthetic.main.activity_add_note.*

class AddEditNoteActivity : AppCompatActivity() {
    companion object {
        const val EXTRA_ID = "com.akeno.praktikum10.EXTRA_ID"
        const val EXTRA_JUDUL = "com.akeno.praktikum10.EXTRA_JUDUL"
        const val EXTRA_DESKRIPSI = "com.akeno.praktikum10.EXTRA_DESKRIPSI"
        const val EXTRA_PRIORITAS = "com.akeno.praktikum10.EXTRA_PRIORITAS"     }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.setHomeAsUpIndicator(R.drawable.ic_save_black_24dp)
